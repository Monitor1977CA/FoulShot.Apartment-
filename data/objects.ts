...
export const rawObjects: Omit<StoryObject, 'isEvidence' | 'assignedToSuspectIds'>[] = [
    ...
    { "id": "obj_ariel_file_1", "name": "Ariel's 911 Call Record", "description": "A record of a 911 call made by Ariel two months ago, reporting a verbal dispute with Malcolm during a custody exchange. No charges were filed, but it documents their volatile relationship.", "category": "police_file", "ownerCharacterId": "char_ariel_cole", "locationFoundId": "loc_ariel_home_living_room", "timestamp": "2025-02-20T00:00:00Z", "hasBeenUnlocked": false, "rarity": "circumstantial", "imagePrompt": "A photorealistic printout of a police dispatch report. The names 'Ariel Cole' and 'Malcolm Cole' are visible under 'Parties Involved'.", "tags": [], "components": [] },

    // --- Ariel kitchen counter items (previously missing) ---
    { "id": "obj_tesla_keys", "name": "Tesla Key Card", "unidentifiedDescription": "A sleek black Tesla key card sits next to a small set of keys on a marble countertop.", "description": "A Tesla key card registered to Ariel Cole's Model X. Its presence on the kitchen counter links Ariel's vehicle to items found connected to the crime scene and suggests recent movement.", "category": "physical", "ownerCharacterId": "char_ariel_cole", "locationFoundId": "loc_ariel_home_kitchen", "timestamp": "2025-04-13T21:45:00Z", "costToUnlock": 0, "hasBeenUnlocked": false, "rarity": "circumstantial", "imagePrompt": "A photorealistic close-up of a black Tesla key card resting on a white marble kitchen counter next to a small metal keyring.", "tags": [], "components": [] },

    { "id": "obj_airbnb_keys", "name": "Airbnb Rental Keys", "unidentifiedDescription": "A small set of rental keys with a hotel-style fob labelled 'Atherton'.", "description": "A set of rental keys labeled for the Atherton Airbnb. Their presence in Ariel's home raises questions about recent contact between Ariel and the crime scene property.", "category": "physical", "ownerCharacterId": "char_ariel_cole", "locationFoundId": "loc_ariel_home_kitchen", "timestamp": "2025-04-13T21:50:00Z", "costToUnlock": 0, "hasBeenUnlocked": false, "rarity": "circumstantial", "imagePrompt": "A photorealistic image of a small bunch of keys with a plastic fob stamped 'Atherton' on a marble countertop.", "tags": [], "components": [] },

    // Stubs added to satisfy evidenceGroup references and avoid missing object errors during validation.
    { "id": "obj_walter_social_1", "name": "Walter's Social Post", "description": "A social media post from Walter Halley referencing a recent family dispute.", "category": "socialMedia", "ownerCharacterId": "char_walter_halley", "locationFoundId": "loc_walter_home_living_room", "timestamp": "2025-04-10T12:00:00Z", "hasBeenUnlocked": false, "rarity": "irrelevant", "imagePrompt": "A styled social media post image.", "tags": [], "components": [] },
    { "id": "obj_walter_records_1", "name": "Walter's Records", "description": "A small folder of personal records belonging to Walter Halley.", "category": "document", "ownerCharacterId": "char_walter_halley", "locationFoundId": "loc_walter_home_office", "timestamp": "2025-04-10T12:00:00Z", "hasBeenUnlocked": false, "rarity": "irrelevant", "imagePrompt": "A simple photograph of a small folder of documents.", "tags": [], "components": [] },
    { "id": "obj_legal_letters", "name": "Legal Letters", "description": "A stack of legal letters related to the custody dispute.", "category": "document", "locationFoundId": "loc_apex_offices", "timestamp": "2025-04-09T09:00:00Z", "hasBeenUnlocked": false, "rarity": "irrelevant", "imagePrompt": "A photorealistic image of a stack of legal letters.", "tags": [], "components": [] },
    { "id": "obj_voicemail_ariel", "name": "Ariel's Voicemail", "description": "A recorded voicemail left by Ariel Cole.", "category": "audio_recording", "ownerCharacterId": "char_ariel_cole", "locationFoundId": "loc_ariel_home_living_room", "timestamp": "2025-04-11T08:30:00Z", "hasBeenUnlocked": false, "rarity": "irrelevant", "imagePrompt": "An interface image representing a voicemail recording.", "tags": [], "components": [] },
    { "id": "obj_walter_file_2", "name": "Walter File 2", "description": "An internal file from Walter Halley's records.", "category": "document", "ownerCharacterId": "char_walter_halley", "locationFoundId": "loc_walter_home_office", "timestamp": "2025-04-10T08:00:00Z", "hasBeenUnlocked": false, "rarity": "irrelevant", "imagePrompt": "A basic file folder image.", "tags": [], "components": [] }
];