...
export const GAME_MECHANICS = {
  ...
  /** Cost to ask a follow-up question. Set to 0 for playtesting. */
  QUESTION_COST: 0,
  /** Cost to turn a piece of testimony into evidence. Set to 0 for playtesting. */
  CREATE_TESTIMONY_EVIDENCE_COST: 0,
};
...
export const API_CONFIG = {
  ...
  /** The number of times to retry a failed image generation request. */
  MAX_RETRIES: 2,
  /** The delay in milliseconds between each retry pass for failed images. */
  RETRY_PASS_DELAY: 2000,
};
