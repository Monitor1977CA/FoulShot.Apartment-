            ...
            <div className="pt-3 mt-3 border-t border-brand-border/20 z-10 relative">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    {/* 
                      --- TOKEN ECONOMY HIDDEN FOR PLAYTESTING ---
                      The token cost for creating evidence from testimony is commented out.
                      The ability to afford this is handled by a high initial token count in config.ts.
