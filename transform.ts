/**
 * @file data/transform.ts
 * @description This file contains the data transformation logic for the story.
 * It is imported and executed by the build script (`scripts/compileContent.ts`) to
 * generate the static `content.json` file. This ensures a clean separation between
 * build-time data processing and run-time data loading.
 */
...
export const transformStoryData = (): StoryData => {
